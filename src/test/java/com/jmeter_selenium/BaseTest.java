...
public class BaseTest {
    ...
    public void setup() {
        ...
        if (driver == null) {
            // ✅ Télécharge et configure automatiquement le bon ChromeDriver
            WebDriverManager.chromedriver().setup();

            // ✅ Démarre ChromeDriver sans options
            driver = new ChromeDriver();
            System.out.println("[SETUP] WebDriver local initialisé avec succès !");
        } else {
            System.out.println("[SETUP] WebDriver déjà initialisé !");
        }
